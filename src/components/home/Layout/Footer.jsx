...
function Footer () {
  return (
    <footer className='flex items-stretch justify-between w-[80%] max-[1200px]:w-[90%]  gap-[100px] relative left-0 mt-[150px]  border-t-[1px] pt-1 border-gray-100 max-[970px]:flex-col'>
